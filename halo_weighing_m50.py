#New Subcount for Illustris Hydro, designed for M(<R) output.
#This weighs each halo by its value for M(<50 kpc)
import sys
import numpy as np
...
#File paths to save
saveFile = './halo_weighing_m50_'+constName+'_illustris-1.npy'
