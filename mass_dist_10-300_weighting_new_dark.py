...
#gasInFile = './kdTree_complete_10-300kpc_gas_Illustris-1.npy'
#starInFile = './kdTree_complete_10-300kpc_star_Illustris-1.npy'

"""
dmInFile = './kdTree_combined_dm_Illustris-3.npy'
gasInFile = './kdTree_combined_gas_Illustris-3.npy'
starInFile = './kdTree_combined_star_Illustris-3.npy'
"""
#Loading in files
...
#np.save('m50_1.npy',[dmMassDist[4],gasMassDist[4],gasMassDist[4]])
#Finding minimum and maximum for M(<R)
#massMinArray = np.apply_along_axis(np.min,1,massDistArray)
#massMaxArray = np.apply_along_axis(np.max,1,massDistArray)
...
print vCircHighErr
pl.errorbar(radArray,vCircArray, yerr = [vCircLowErr,vCircHighErr], fmt = 's')
#pl.plot(radArray,vCircArray,marker='o')
pl.xlabel('R (kpc)')
pl.ylabel(r'$V_{circ}$ (km/s)')
#pl.ylabel(r'P($M(<50kpc)|M_{tot}$)')
#pl.xscale('log')
#pl.yscale('log')
pl.xlim([0,310])
pl.ylim([0,250])
pl.title('Illustris-1 Circular Velocity Distribution (Deason et al. 2012; Gauss Weighting)')
pl.show()
...
outFile1 = './massdist_deason_e11-13_'+fileLabel+'_illustrisdark1_new.npy'
outArray2 = [radArray, vCircArray,vCircLowErr,vCircHighErr]
outFile2 = './veldist_deason_e11-13_'+fileLabel+'_illustrisdark1_new.npy'
